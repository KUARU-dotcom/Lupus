...
MODELS = {
    ...
    "merged_lupus_model": {"base_url": "http://localhost:1234/v1", "api_key": LM_STUDIO_KEY, "model": "merged_lupus_model", "max_tokens": 700,  "disable_thinking": True},
    "deepseek-v4-flash":  {"base_url": "https://knyazevai.work/v1", "api_key": KNYAZEV_KEY,  "model": "deepseek-v4-flash",  "max_tokens": 2000},
    "kimi-2.6":           {"base_url": "https://knyazevai.work/v1", "api_key": KNYAZEV_KEY,  "model": "kimi-2.6",           "max_tokens": 2000},
    "minimax-2.7":        {"base_url": "https://knyazevai.work/v1", "api_key": KNYAZEV_KEY,  "model": "minimax-2.7",        "max_tokens": 2000},
}
